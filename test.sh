...
time ./src/signalserverLIDAR -lid data/sk3587_50cm.asc -lat 53.383 -lon -1.468 -txh 8 -f 446 -erp 1 -rxh 2 -m -dbm -rt -90 -o ${testDir}/1_Original -R 0.5 -t
...
time ./src/signalserverLIDAR -lid data/N051E000_AVE_DSM.tif.asc,data/N051W001_AVE_DSM.tif.asc -lat 51.472 -lon 0.0096 -txh 12 -f 446 -erp 5 -rxh 2 -m -dbm -rt -100 -o ${testDir}/2_Original -R 10 -t
echo "Converting to PNG..."
...
time ./src/signalserver -sdf ${demDir} -lat 42.328889 -lon -87.862500 -txh 300 -rxh 2 -f 446 -erp 700 -R 50 -res 600 -rt 39 -ant antenna/DB413-B -rot 180 -udt data/test.udt -pm 1 -t -o ${testDir}/ant-udt_test_Original
echo "Converting to PNG..."
...
time ./src/signalserverHD -pm 1 -sdf ${demDir} -lat 46.977815 -lon 7.528691 -txh 40.0 -erp 4.0 -f 161.3 -rxh 1.5 -dbm -rt -90.0 -m -R 40.0 -o ${testDir}/REGACOM_ITM_Original
echo "Converting to PNG..."
...
time ./src/signalserverHD -pm 2 -sdf ${demDir} -lat 46.977815 -lon 7.528691 -txh 40.0 -erp 4.0 -f 161.3 -rxh 1.5 -dbm -rt -90.0 -m -R 50.0 -o ${testDir}/REGACOM_LOS_Original
echo "Converting to PNG..."
...
time ./src/signalserverHD -pm 3 -sdf ${demDir} -lat 46.977815 -lon 7.528691 -txh 40.0 -erp 4.0 -f 161.3 -rxh 1.5 -dbm -rt -90.0 -m -R 50.0 -o ${testDir}/REGACOM_Hata_Original
echo "Converting to PNG..."
...
time ./src/signalserverHD -pm 4 -sdf ${demDir} -lat 46.977815 -lon 7.528691 -txh 40.0 -erp 4.0 -f 161.3 -rxh 1.5 -dbm -rt -90.0 -m -R 50.0 -o ${testDir}/REGACOM_ECC33_Original
echo "Converting to PNG..."
...
time ./src/signalserverHD -pm 5 -sdf ${demDir} -lat 46.977815 -lon 7.528691 -txh 40.0 -erp 4.0 -f 161.3 -rxh 1.5 -dbm -rt -90.0 -m -R 50.0 -o ${testDir}/REGACOM_SUI_Original
echo "Converting to PNG..."
...
time ./src/signalserverHD -pm 6 -sdf ${demDir} -lat 46.977815 -lon 7.528691 -txh 40.0 -erp 4.0 -f 161.3 -rxh 1.5 -dbm -rt -90.0 -m -R 50.0 -o ${testDir}/REGACOM_COST-Hata_Original
echo "Converting to PNG..."
...
time ./src/signalserverHD -pm 7 -sdf ${demDir} -lat 46.977815 -lon 7.528691 -txh 40.0 -erp 4.0 -f 161.3 -rxh 1.5 -dbm -rt -90.0 -m -R 50.0 -o ${testDir}/REGACOM_FSPL_Original
echo "Converting to PNG..."
...
time ./src/signalserverHD -pm 8 -sdf ${demDir} -lat 46.977815 -lon 7.528691 -txh 40.0 -erp 4.0 -f 161.3 -rxh 1.5 -dbm -rt -90.0 -m -R 40.0 -o ${testDir}/REGACOM_ITWOM_Original
echo "Converting to PNG..."
...
time ./src/signalserverHD -pm 9 -sdf ${demDir} -lat 46.977815 -lon 7.528691 -txh 40.0 -erp 4.0 -f 161.3 -rxh 1.5 -dbm -rt -90.0 -m -R 50.0 -o ${testDir}/REGACOM_Ericsson_Original
echo "Converting to PNG..."
...
time ./src/signalserverHD -pm 11 -sdf ${demDir} -lat 46.977815 -lon 7.528691 -txh 40.0 -erp 4.0 -f 161.3 -rxh 1.5 -dbm -rt -90.0 -m -R 50.0 -o ${testDir}/REGACOM_Egli_Original
echo "Converting to PNG..."
